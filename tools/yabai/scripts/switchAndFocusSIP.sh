...
#
# If I have focus of window on display 1 and change spces on display 1, I'll check to see if there is any
# windows to focus on on display 1's next space, if there IS, i'll move foucs to it, else I'll move focus
# to any VISIBLE window on display's 2 or 3 in order to keep SOMETHING focused. If there is no visible windows
# on the new space or displays 2 and 3, Nothing will take focus, which is fine.
#
# If I have NOTHING focused and I change spaces, try to focus on ANY visible window on the new space. Else,
# try to focus on any visibe window on any visible space.
#=============================================================================================================
...
'1')
    firstSpaceName='right'
    firstspacenumber='1'
    secondSpaceName='center'
    secondSpacenumber='3'
    ;;
'2')
    firstSpaceName='center'
    firstspacenumber='3'
    secondSpaceName='left'
    secondSpacenumber='2'
    ;;
'3')
    firstSpaceName='left'
    firstspacenumber='2'
    secondSpaceName='right'
    secondSpacenumber='1'
    ;;
esac
