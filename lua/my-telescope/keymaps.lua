...
key_map("n", "<localleader>st", ":lua require'my-telescope'.search_todos()<CR>", { noremap = true, silent = true })
...
-- telescope-repo
key_map("n", "<localleader>rl", [[<Cmd>lua require'my-telescope'.repo_list()<CR>]], { noremap = true, silent = true })
...
key_map("n", "<localleader>tr", [[<Cmd>lua require'telescope.builtin'.resume()<CR>]], { noremap = true, silent = true })
...
key_map("n", ",<space>", [[<Cmd>lua require'my-telescope'.project_files()<CR>]], { noremap = true, silent = true })
-- browse, explore and create notes
key_map("n", ",n", [[<Cmd>lua require'my-telescope'.browse_notes()<CR>]], { noremap = true, silent = true })
-- Explore files starting at $HOME
key_map("n", ",e", [[<Cmd>lua require'my-telescope'.file_explorer()<CR>]], { noremap = true, silent = true })
...
-- grep word under cursor - case-sensitive (exact word) - made for use with Replace All - see <localleader>ra
key_map(
    "n",
    "<localleader>G",
...
-- find notes
key_map("n", "<localleader>n", [[<Cmd>lua require'my-telescope'.find_notes()<CR>]], { noremap = true, silent = true })
-- search notes
key_map("n", "<space>n", [[<Cmd>lua require'my-telescope'.grep_notes()<CR>]], { noremap = true, silent = true })
-- Find files in config dirs
key_map("n", "<space>e", [[<Cmd>lua require'my-telescope'.find_configs()<CR>]], { noremap = true, silent = true })
-- greg for a string
key_map("n", "<space>g", [[<Cmd>lua require'my-telescope'.grep_prompt()<CR>]], { noremap = true, silent = true })
-- find or create neovim configs
key_map("n", "<localleader>nc", [[<Cmd>lua require'my-telescope'.nvim_config()<CR>]], { noremap = true, silent = true })

-- Github issues
key_map("n", "<localleader>is", [[<Cmd>lua require'my-telescope'.gh_issues()<CR>]], { noremap = true, silent = true })
-- github Pull Requests - PRs
key_map("n", "<localleader>pr", [[<Cmd>lua require'my-telescope'.gh_prs()<CR>]], { noremap = true, silent = true })
...
key_map(
    "n",
    "<localleader>ns",
    [[<Cmd>lua require'my-telescope'.grep_nvim_src()<CR>]],
    { noremap = true, silent = true }
)
-- End Telescope maps
